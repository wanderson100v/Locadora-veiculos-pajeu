    	...
    	try {
	    	...
	    	if(fonte == buscarBtn) {
	    		if(toggleGroup.getSelectedToggle()!= null) {
	    			...
	    			Alerta.getInstance().imprimirMsg("Alerta", "É necessário selecionar uma opção de busca para filial",AlertType.WARNING);
	    		...
	    		if(funcionario.getFilial() != null) {
	    			...
	    			Alerta.getInstance().imprimirMsg("Alerta", "O Funcionário não esta relacionado a nenhuma filial",AlertType.WARNING);
	    		}
