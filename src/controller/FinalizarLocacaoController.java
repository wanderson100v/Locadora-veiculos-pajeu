		...
		try {
			...
			if (e.getSource() == devuAtualCk)
				...
				if (etCk.isSelected()
					...
					errosEmTela.append(
							"- Abastecimento para veículo selecionado, é necessário também definir data e hora para execução\n");
				if (lpCk.isSelected()
						&& (!lpAtualCk.isSelected() && (lpDate.getValue() == null || lpHoraBox.getValue() == null)))
					errosEmTela.append(
							"- Limpeza para veículo selecionada, é necessário também definir data e hora para execução\n");
